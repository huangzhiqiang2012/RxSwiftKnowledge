//
//  SubjectsAndVariablesController.swift
//  RxSwiftKnowledge
//
...
class SubjectsAndVariablesController: BaseController {
    ...
    override func viewDidLoad() {
        ...
        /// 第1次订阅subject
        _ = subject1.subscribe(onNext: { (str) in
            print("第1次订阅:", str)
        }, onCompleted: {
        ...
        /// 第2次订阅subject
        _ = subject1.subscribe(onNext: { string in
            print("第2次订阅：", string)
        }, onCompleted:{
